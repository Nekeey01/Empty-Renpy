...
init python:
    gui.init(1920, 1080)
    vidos = Movie("img/menu/Doki_doki_xvid.webm")
...
define gui.accent_color = '#930000'
...
define gui.text_font = "fonts/text.ttf"
...
define gui.main_menu_background = "img/menu/menu.jpg"
define gui.game_menu_background = "img/menu/menu.jpg"
...
## порядку.
define gui.namebox_borders = Borders(100, 0, 706, 33) #(81, 806, 706, 840) 
...
define gui.dialogue_height = 220
